...
Both tools have Workflow-only invocation scope. Delegated specialist children cannot invoke workspace-native tools. Target adapters also reject workspace tools; Kubernetes and VM native tools continue through AgentK and AgentV.
