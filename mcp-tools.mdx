...
| Builtin VM tools | AgentV | The agent advertises strict Linux/systemd tools over `tools/list`; the control plane synchronizes complete input, output, artifact, timeout, and capability contracts. |
