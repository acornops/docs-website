...
If you are building a bot, workflow adapter, or custom client, start with [Integrations](/integrations) for the supported auth and event patterns before wiring endpoint calls.
