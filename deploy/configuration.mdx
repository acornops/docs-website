...
<CardGroup cols={2}>
  ...
  <Card title="MCP endpoints and egress" icon="plug" href="/deploy/configuration-reference#mcp-egress-policy">
    Constrain remote MCP destinations and configure access to approved endpoints.
  </Card>
