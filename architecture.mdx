...
| --- | --- | --- |
| Management console | Workspace, target, member, tool, and session user experience | `https://console.acornops.dev/` |
| Control plane | Auth, workspaces, target core, Kubernetes and VM APIs, agent WebSockets, run state, webhooks, API authorization | `https://api.acornops.dev/api/v1` |
