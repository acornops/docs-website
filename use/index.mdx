...
<CardGroup cols={2}>
  <Card title="Join an existing platform" icon="right-to-bracket" href="/use/get-started">
    Sign in, accept a workspace invitation, and find your first connected target.
  </Card>
