...
Web Search is not part of the `target.diagnostics.read` semantic capability used by starter specialist Agents. Enablement on a target does not automatically grant it to a Workflow.
