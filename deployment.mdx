...
| Input | Notes |
| --- | --- |
| Public API host | Defaults to `api.acornops.dev` for API routes. |
...
| Mattermost chat service token | Required when enabling the registered Mattermost bot account-link flow. |
