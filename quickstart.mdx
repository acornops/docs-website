...
- start a read-only or policy-gated read-write troubleshooting session based on your workspace role, target type, local agent capabilities, and target policy.
