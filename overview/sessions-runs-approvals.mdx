...
The management console exposes active and historical runs, their origin, target, state, safe outputs, and pending approvals. Authorization is rechecked at dispatch and before each tool call.
